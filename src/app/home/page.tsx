            ...
            {!isLoading && situations.length > 0 && (
              <div className="flex items-center gap-4 sm:gap-6">
                <div className="text-center">
                  <div className="text-lg font-bold text-gray-900 dark:text-white">{situations.length}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">お気に入り</div>
                </div>
                <div className="w-px h-8 bg-gray-200 dark:bg-gray-700" />
                <div className="text-center">
                  <div className="text-lg font-bold text-green-500">{publicCount}</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">公開中</div>
                </div>
              </div>
            )}
          </div>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">準備したい場面を追加しましょう</p>
              </div>
              <button
                onClick={() => setShowModal(false)}
