      ...
      <main className="relative flex-1 min-h-0 flex flex-col max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-4">
        ...
        <div className="mb-6 animate-fadeUp">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-4">
            <div>
              <p className="text-sm text-brand-600 dark:text-brand-400 font-medium mb-1">{getGreeting()}</p>
        ...
        {isLoading ? (
          <div className="h-full grid grid-flow-col grid-rows-1 md:grid-rows-2 auto-cols-[minmax(16rem,80vw)] sm:auto-cols-[minmax(20rem,60vw)] lg:auto-cols-[calc((100%-7rem)/3)] gap-4 overflow-x-auto pb-2 mt-3 pt-2">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
          ...
          <div className="text-center py-12 animate-fadeUp mt-3">
            ...
            <button
              onClick={() => setShowModal(true)}
              className="btn-primary inline-flex items-center justify-center w-10 h-10 p-0 shadow-glow"
          ...
          /* Grid */
          <div className="h-full grid grid-flow-col grid-rows-1 md:grid-rows-2 auto-cols-[minmax(16rem,80vw)] sm:auto-cols-[minmax(20rem,60vw)] lg:auto-cols-[calc((100%-7rem)/3)] gap-4 overflow-x-auto pb-2 animate-fadeUp stagger-2 mt-3 pt-2">
