              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 rounded-2xl glass-card-muted px-3 py-2 transition-all duration-300 focus-within:shadow-xl focus-within:shadow-brand-500/10 focus-within:border-brand-400/50 dark:focus-within:border-brand-500/50">
                ...
                <div className="flex items-center gap-2 relative" ref={labelDropdownRef}>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all duration-200 transition-transform hover:scale-[1.03] active:scale-95 ${
                      filterFavoritesOnly
                  ...
                  <div className="relative" ref={visibilityDropdownRef}>
                    ...
                    <div
                      className={`absolute left-0 top-full mt-2 w-40 rounded-2xl bg-surface border border-line shadow-xl z-50 overflow-hidden origin-top transition-all duration-200 ${
                        isVisibilityOpen
                          ? 'opacity-100 scale-100 pointer-events-auto'
                          : 'opacity-0 scale-95 pointer-events-none'
                      }`}
                      aria-hidden={!isVisibilityOpen}
                    >
                      <button
                        type="button"
                        onClick={() => {
                  ...
                  <div
                    className={`absolute right-0 top-full mt-2 w-64 rounded-2xl bg-surface border border-line shadow-xl z-50 overflow-hidden origin-top transition-all duration-200 ${
                      isLabelOpen
                        ? 'opacity-100 scale-100 pointer-events-auto'
                        : 'opacity-0 scale-95 pointer-events-none'
                    }`}
                    aria-hidden={!isLabelOpen}
                  >
