            ...
            <div className="grid grid-flow-col grid-rows-2 auto-cols-[minmax(18rem,80vw)] sm:auto-cols-[minmax(20rem,60vw)] lg:auto-cols-[calc((100%-7rem)/3)] gap-6 overflow-x-auto pb-2">
              {situations.map((situation, index) => (
                <div
                  ...
                  className={`group glass-card-solid rounded-2xl p-6 cursor-pointer card-hover border-2 border-transparent hover:border-brand-200 dark:hover:border-brand-500/30 animate-fadeUp stagger-${Math.min(index + 1, 6)} flex flex-col h-[14rem]`}
                >
                  {/* Card Header */}
