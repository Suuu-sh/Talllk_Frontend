  ...
  return (
    <div className="min-h-screen flex flex-col bg-base transition-colors duration-300">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-0 w-80 h-80 bg-purple-600/2 rounded-full blur-3xl" />
        <div className="absolute top-1/3 right-10 w-72 h-72 bg-brand-900/2 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-brand-900/2 rounded-full blur-3xl" />
        <div className="absolute bottom-10 right-0 w-96 h-96 bg-brand-900/3 rounded-full blur-3xl" />
      </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 animate-fadeUp">
          <div>
            ...
            <h1 className="text-2xl font-bold text-ink">
              {t({ ja: 'みんなの準備を探す', en: 'Discover situations' })}
            </h1>
          </div>
          ...
          <div className="text-center py-12 animate-fadeUp">
            ...
            <p className="text-ink-muted max-w-md mx-auto">
              {searchQuery
                ...
                : t({
                    ja: 'まだ公開されているシチュエーションがありません。しばらくお待ちください。',
                    en: 'There are no public situations yet. Please check back soon.',
                  })}
            </p>
          </div>
        ) : (
